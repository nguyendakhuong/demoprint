  ...
  return (
    <div className="dialog-overlay" onClick={handleClickOutside}>
      <div className="modal-content" ref={modalRef}>
        ...
        />
        <label>Mô tả</label>
        <CustomSunEditor value={description} onChange={setDescription} />;
        <label>Kết quả</label>
        <CustomSunEditor value={result} onChange={setResult} />;
        <label>Khuyến nghị</label>
        <CustomSunEditor value={recommendation} onChange={setRecommendation} />;
